...
def get_config():
    ...
    parser.add_argument("--algorithm_name", type=str,
                        default='mat', choices=["RW_comm", "RW_comm_dec"])
    ...
    parser.add_argument("--Threshold_loc_radio", type=float, default=0.8)
    parser.add_argument("--Threshold_Real_radio", type=float, default=0.8)
