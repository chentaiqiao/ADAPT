import torch
import numpy as np
from random_walk_comm.utils.util import update_linear_schedule
from random_walk_comm.utils.util import get_shape_from_obs_space, get_shape_from_act_space
...
class TransformerPolicy:
    ...
    def __init__(self, args, obs_space, cent_obs_space, act_space, num_agents, device=torch.device("cpu")):
        ...
        if self.algorithm_name in ["RW_comm", "RW_comm_dec"]:
            from random_walk_comm.algorithms.mat.algorithm.cformer import RW_comm as MAT
        else:
        ...
        self.transformer = MAT(self.share_obs_dim, self.obs_dim, self.act_dim, num_agents,
                               ...
                               share_actor=args.share_actor, k_steps=args.k_steps, 
