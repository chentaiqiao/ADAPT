...
from ADAPT.algorithms.utils.util import check, init
from ADAPT.algorithms.utils.transformer_act import discrete_autoregreesive_act#mat.algorithms.utils.transformer_act
from ADAPT.algorithms.utils.transformer_act import discrete_parallel_act
from ADAPT.algorithms.utils.transformer_act import continuous_autoregreesive_act
from ADAPT.algorithms.utils.transformer_act import continuous_parallel_act
...
class RW_comm(nn.Module):
    ...
    def __init__(self, state_dim, obs_dim, action_dim, n_agent,
                 ...
                 action_type='Discrete', dec_actor=False, share_actor=False, k_steps=3, 
